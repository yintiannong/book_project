...
class TOrder(models.Model):
    ...
    address = models.ForeignKey(TAddress,  blank=True, null=True,on_delete=models.CASCADE)
    user = models.ForeignKey('TUser',  blank=True, null=True,on_delete=models.CASCADE)
...
class TUser(models.Model):
    ...
    email_getcha = models.CharField(max_length=1000, blank=True, null=True)
